...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-jinja2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13194&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-jinja2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-jinja2` can be installed with:

```
conda install types-jinja2
```

It is possible to list all of the versions of `types-jinja2` available on your platform with:
